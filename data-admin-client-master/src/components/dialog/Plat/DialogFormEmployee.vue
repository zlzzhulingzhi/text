...
export default {
  ...
  data() {
    ...
    return {
      ...
      typeMapping: {
        EmployeeCreate: {title: '新增员工', submitFn: this.$api.Employee.adminCreate, showPassword: false, type: 'Create'},
        EmployeeEdit: {title: '编辑员工', submitFn: this.$api.Employee.adminUpdate, showPassword: false, type: 'Edit'}
      },
      defaultFormData,
      formData: {
        ...defaultFormData
