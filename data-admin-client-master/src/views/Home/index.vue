<template>
  ...
  <div class="full-screen overflow relative page-container" v-else>
    ...
    <!-- <el-image class="bg-positon" :src="require('@/assets/main/new_top.gif')" fit="fill"></el-image> -->
    ...
    <div class="page-content" :style="pageComputed.style">
      ...
      <div class="flex relative contents" :style="{
        ...
        <div class="flex column content-center">
          ...
          <TodayClass class="margin-top-28"></TodayClass>
        </div>
...
<script>
import SvgBG from '@/views/Home/components/SvgBG'
import BannerView from '@/views/Home/panes/BannerView'
import DataOverview from '@/views/Home/panes/DataOverview'
import CoSponsors from '@/views/Home/panes/CoSponsors'
import ImportantNotice from '@/views/Home/panes/ImportantNotice'
import RealTimeData from '@/views/Home/panes/RealTimeData'
import StudentData from '@/views/Home/panes/StudentData'
import TodayClass from '@/views/Home/panes/TodayClass'
import WinnersShow from '@/views/Home/panes/WinnersShow'
import CombinedUseBase from '@/views/Home/panes/CombinedUseBase'
...
export default {
  ...
  methods: {
    ...mapMutations({
      updateScaleNum: 'system/updateScaleNum'
    }),
  }
}
</script>
...
.page-container
  ...
  background-image url('~@/assets/main/b.gif')
