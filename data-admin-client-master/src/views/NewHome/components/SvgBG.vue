<template>
  <svg class="absolute svg" :width="screen.width" :height="screen.height">
    ...
    <image :x="(screen.width - 1920) / 2" :xlink:href="require('@/assets/main/top.png')"></image>
    <text :x="screen.width / 2 + 6" :y="options.mg + options.title_h * 0.6" font-size="26" fill="#FFF"
