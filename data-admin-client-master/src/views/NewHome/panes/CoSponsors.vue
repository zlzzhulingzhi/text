<template>
  <ItemWrap :heightHalfFull="true" :backgroud="require('@/assets/main/bg_side_top.png')">
    <div slot="title">网络万人培训资助计划</div>
    <ItemSubWrap>
      ...
      <div class="flex column height-120 text-f">
        <div class="flex-1 flex start-center" v-for="(row, index) in groupList" :key="index">
          <div class="flex-1 flex column center-center" v-for="item in row" :key="item.fieldCode">
            <el-image class="width-60" :src="require(`@/assets/main/img_spon_${item.fieldCode}.png`)"
              alt="开班课程"></el-image>
