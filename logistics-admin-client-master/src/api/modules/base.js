...
// 查询字典表树  宿舍类型、单元、楼层、教室类型、职称、面积单位
export const QueryInfo = {
  info: params => $BASIC.post(`/dict/tree/list`, params)
}

// 流程管理  负责人数据
export const PrincipalInfo = {
  // 用户
  userPage: params => $BASIC.post(`user/pageList`, params),
  // 角色
  rolePage: params => $BASIC.post(`role/pageList`, params),
}