...
export const formatMoney = (value, n = 2, isFormatIntPart = true, isFront = true, splicingUnit = '¥') => {
  ...
  if (!floatPart) return isFront ? splicingUnit + intPart : intPart + splicingUnit;
  floatPart = floatPart.toString().split('').reverse().join('')
  return isFront ? splicingUnit + intPart + '.' + floatPart : intPart + '.' + floatPart + splicingUnit;
}
