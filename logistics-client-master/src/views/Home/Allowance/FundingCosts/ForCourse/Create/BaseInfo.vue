  ...
  <el-card>
    <el-form ref="form" :model="formData" :rules="rules"
      ...
      <div ref="formWrapper" class="content overflow-auto" :style="pageInfo.pageStyle" :class="{elFormItemMarginBottom: detailCSS}">
        ...
        <div class="section">
          ...
          <div>
            ...
            <el-form-item prop="applyDate" label="申请时间">
              <el-date-picker class="setWidth" type="date" placeholder="选择申请时间" v-model="formData.applyDate" :picker-options="pickerOptions" format="yyyy-MM-dd" value-format="yyyy-MM-dd" v-if="!detailCSS"></el-date-picker>
        ...
        <!-- 课程详情信息 -->
        <div class="section">
          <div class="section-title">课程专题详情</div>
                  ...
                  <el-table :data="formData.applyAllowanceAddRequest.applyAllowanceStudentAddRequests" :style="{minHeight: '0'}">
                    ...
                    <el-table-column label="考试成绩（分）" prop="examScore">
                      <template slot-scope="{ row }">
                        ...
                        <el-input-number v-else class="elInputInStudentTable inputCenter" size="small" type="number" :precision="1" :controls="false" :min="0" :max="100" 
                              v-model="row.examScore" ></el-input-number>
                      </template>
                    </el-table-column>
                    <el-table-column label="考试结果" prop="examResult">
                      <template slot-scope="{ row }">
                        ...
                        <el-input v-else type="text" size="small" class="elInputInStudentTable" v-model="row.examResult" placeholder="请输入" maxlength="10"></el-input>
                      </template>
                    </el-table-column>
  ...
  methods: {
    ...
    async onInitFormData() {
      ...
      if (this.info && this.info?.applyAllowanceDetailResponse?.applyId) {
        ...
        // 处理学员列表信息，examScore为null时将其设置为undefined
        needInfo.applyAllowanceStudentDetailResponseList.map((item) => {
