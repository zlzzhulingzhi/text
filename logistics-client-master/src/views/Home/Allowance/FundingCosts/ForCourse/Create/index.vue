...
<div>
    ...
    <!-- <el-button type="primary" size="small" v-if="type === 'View'" class="absolute goBackButton" @click="goToCourse">返回</el-button> -->

</div> 
</template>

<script>
import BaseInfo from '@/views/Home/Allowance/FundingCosts/ForCourse/Create/BaseInfo'
import AttachInfo from '@/views/Home/Allowance/FundingCosts/ForCourse/Create/AttachInfo'
    ...
    pageInfo() {
      let typeMapping = {
        Create: {
          ...
          detailAPI: this.$api.ApplyCost.detailCourse,
          submitAPI: this.$api.ApplyCost.saveCourse
        },
        Edit: {
          pageClassName: 'edit',
          detailAPI: this.$api.ApplyCost.detailCourse,
          submitAPI: this.$api.ApplyCost.updateCourse
        },
        View: {
          pageClassName: 'view',
          detailAPI: this.$api.ApplyCost.detailCourse,
