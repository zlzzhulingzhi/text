...
import cn.qbs.wa.teach.common.core.exception.auth.NotLoginException;
...
import cn.qbs.wa.teach.common.core.utils.SpringUtils;
...
public class AuthLogic
{
    ...
    {
        return authorities != null && authorities.stream().filter(StringUtils::hasText)
    ...
    {
        return roles != null && roles.stream().filter(StringUtils::hasText)
