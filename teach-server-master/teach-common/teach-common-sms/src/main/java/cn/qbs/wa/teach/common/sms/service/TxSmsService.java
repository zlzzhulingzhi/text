...
import cn.qbs.wa.teach.common.sms.config.TxSmsConfig;
...
public class TxSmsService implements SmsService{
    ...
    public String sendVerCodeMsg(String phone, Integer length) {
        String code = VerificationCodeUtil.create(length);
        sendRegCode(config.getSecretId(), config.getSecretKey(), config.getAppId(), config.getSign(), config.getTemplateId(), new String[]{code}, phone);
        return code;
    }
    ...
    */
    private void sendRegCode(String secretId, String secretKey, String appId, String sign, String templateId, String[] msgCode, String phoneNumber) {
        try {
...
//            String[] phoneNumbers = {"+8621212313123", "+8612345678902", "+8612345678903"};
            ...
            log.info("短信结果{}", SendSmsResponse.toJsonString(res));
