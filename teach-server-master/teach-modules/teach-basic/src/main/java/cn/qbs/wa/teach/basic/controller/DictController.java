...
import cn.qbs.wa.teach.basic.enums.OpenDictCodeEnum;
...
public class DictController {
    ...
    //@Log(title = "新增字典表", businessType = BusinessType.INSERT)
    @ApiOperation("新增")
    ...
    //@Log(title = "更新字典表", businessType = BusinessType.UPDATE)
    @ApiOperation("更新字典表")
    ...
    //@Log(title = "删除字典表", businessType = BusinessType.DELETE)
    @ApiOperation("删除字典表")
