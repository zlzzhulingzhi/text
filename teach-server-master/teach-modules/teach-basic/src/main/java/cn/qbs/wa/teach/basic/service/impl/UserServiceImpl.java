...
import cn.qbs.wa.teach.basic.pojo.app.ApplicationFullDetailResponse;
...
import cn.qbs.wa.teach.basic.service.*;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public User saveUserAdmin(UserAdminAddRequest request) {
        ...
        // 特殊：需要根据当前用户的角色所关联的菜单是否存在"小程序后台管理"类型，决定是否给与"小程序后台"应用权限
        ...
        innerSystemUserAddDTO.setAppCode(UnionAppCodeEnum.TEACH.getCode());
    ...
    private SystemEmployeeUserAddResultDTO addRemoteUnionSystemEmployee(InnerEmployeeUserAddDTO innerEmployeeUserAddDTO, User user, UserOrgAddRequest request) {
        innerEmployeeUserAddDTO.setAppCode(UnionAppCodeEnum.TEACH.getCode());
