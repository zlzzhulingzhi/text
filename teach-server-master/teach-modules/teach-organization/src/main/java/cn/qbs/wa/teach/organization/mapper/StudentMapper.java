...
public interface StudentMapper extends BaseMapper<Student> {
    ...
    @InterceptorIgnore(tenantLine = "true")
    StudentDetailResponse getStudentName(@Param("params") Student params);
    ...
    @InterceptorIgnore(tenantLine = "true")
    StudentInfoResponse selectStu(@Param("request")SocialLoginInfoRequest request);

    @InterceptorIgnore(tenantLine = "true")
    List<String> selectOrgNameByUserId(Serializable id);
}
