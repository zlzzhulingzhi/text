...
import cn.qbs.wa.teach.organization.pojo.studentdept.*;
import cn.qbs.wa.teach.organization.service.StudentDeptService;
...
public class StudentDeptServiceImpl extends ServiceImpl<StudentDeptMapper, StudentDept> implements StudentDeptService {
    ...
    @Resource
    private RemoteCourseDeptService remoteCourseDeptService;
