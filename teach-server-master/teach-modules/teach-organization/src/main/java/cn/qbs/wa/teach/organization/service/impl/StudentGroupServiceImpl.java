...
import cn.qbs.wa.teach.organization.mapper.StudentGroupMapper;
import cn.qbs.wa.teach.organization.pojo.student.StudentIdAndUserIdRequest;
import cn.qbs.wa.teach.organization.pojo.studentgroup.*;
import cn.qbs.wa.teach.organization.service.StudentGroupService;
...
public class StudentGroupServiceImpl extends ServiceImpl<StudentGroupMapper, StudentGroup> implements StudentGroupService {
    ...
    @Resource
    private RemoteCourseGroupService remoteCourseGroupService;
    ...
    public boolean add(StudentGroupAddRequest params) {
        this.remove(Wrappers.<StudentGroup>lambdaQuery().eq(StudentGroup::getStudentId, params.getStudentId()));
