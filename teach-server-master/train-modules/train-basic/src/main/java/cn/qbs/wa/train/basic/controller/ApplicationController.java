...
public class ApplicationController {
     ...
     */
    @PostMapping("add")
    @RequiresPermissions("System:Management:Plat:Application:Create")
    @ApiOperation("新增应用")
     ...
     */
    @PostMapping("page")
    @RequiresPermissions("System:Management:Plat:Application")
     ...
     */
    @PostMapping("update")
    @RequiresPermissions("System:Management:Plat:Application:Edit")
     ...
     */
    @PostMapping("delete")
    @RequiresPermissions("System:Management:Plat:Application:Delete")
    ...
    @RequiresPermissions("System:Management:Plat:Application:Enabled")
