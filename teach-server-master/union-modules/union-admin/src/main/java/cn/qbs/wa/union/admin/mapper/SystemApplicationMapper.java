...
import cn.qbs.wa.union.admin.pojo.systemapplication.SystemApplicationDetailResponse;
import cn.qbs.wa.union.admin.pojo.systemapplication.SystemApplicationPageRequest;
import cn.qbs.wa.union.admin.pojo.systemapplication.SystemApplicationPageResponse;
...
public interface SystemApplicationMapper extends BaseMapper<SystemApplication> {
    ...
    */
    ...
    List<SystemApplication> listByUniAppId(List<Long> uniAppIdList);
}
