...
export const Index = {
  ...
  extraCategoryTree: (params) =>
    $DECORATE.post(`index/extra/category/tree`, params),
  extraLivePage: (params) => $DECORATE.post(`index/extra/live/page`, params),
  extraCoursePage: (params) =>
    $DECORATE.post(`index/extra/course/page`, params),
  extraLecturerPage: (params) =>
    $DECORATE.post(`index/extra/lecturer/page`, params),
...
export const OrgIndexDec = {
  ...
  extraCategoryTree: (params) =>
    $DECORATE.post(`org-index/extra/category/tree`, params),
  extraLivePage: (params) =>
    $DECORATE.post(`org-index/extra/live/page`, params),
  extraCoursePage: (params) =>
    $DECORATE.post(`org-index/extra/course/page`, params),
  extraLecturerPage: (params) =>
    $DECORATE.post(`org-index/extra/lecturer/page`, params),
  extraNewsPage: (params) =>
    $DECORATE.post(`org-index/extra/news/page`, params),
