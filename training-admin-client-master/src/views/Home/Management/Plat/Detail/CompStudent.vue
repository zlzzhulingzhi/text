  ...
  <el-card shadow="never" :body-style="{ padding: '0 0 0' }">
    <TableView :options="options" :params.sync="filterData">
      ...
      <el-table
        v-loading="loading"
        :data="listData"
        :height="$utils.FullViewHeight(317)"
        ...
        <el-table-column :label="$t('user.Name')" prop="realName" sortable="custom"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    async getListData() {
      ...
      this.loading = true;
      let { code, data } = await this.$api.OrgCourse.stuPage(this.params);
      this.loading = false;
